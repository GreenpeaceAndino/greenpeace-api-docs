...
|**AR**|`payment_card_id`|`string`||`payment_gateway_name === "mercadopago"`|`true`||Solo es requerido si `payment_card_issuer_id` es igual a `"mercadopago"`|
|**AR**|`payment_device_id`|`string`||`payment_gateway_name === "mercadopago"`|`true`||Solo es requerido si `payment_card_issuer_id` es igual a `"mercadopago"`|
